...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void createUsersTable() {
        ...
        try (PreparedStatement preparedStatement = new Util().connectionToDB().prepareStatement(CREATE_TABLE);) {
    ...
    public void dropUsersTable() {
        try (PreparedStatement preparedStatement = new Util().connectionToDB().prepareStatement(DROP_TABLE);) {
            preparedStatement.execute();
        } catch (SQLException e) {
    ...
    public void saveUser(String name, String lastName, byte age) {
        try (PreparedStatement preparedStatement = new Util().connectionToDB().prepareStatement(SAVE_USER);) {
    ...
    public void removeUserById(long id) {
        try (PreparedStatement preparedStatement = new Util().connectionToDB().prepareStatement(REMOVE_USER);) {
    ...
    public List<User> getAllUsers() {
        ...
        try (PreparedStatement preparedStatement = new Util().connectionToDB().prepareStatement(GET_USERS);) {
...
//        System.out.println(list);
    ...
    public void cleanUsersTable() {
        try (PreparedStatement preparedStatement = new Util().connectionToDB().prepareStatement(CLEAN_TABLE);) {
            preparedStatement.execute();
        } catch (SQLException e) {
